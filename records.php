...
// FETCH ONLY PENDING RECORDS: This makes resolved cases vanish from this view!
$stmt = $pdo->query("SELECT id, subject AS title, name AS user, created_at, status FROM grievances ORDER BY id DESC");
        ...
        <div class="row">
            ...
            <div class="col-md-2 p-3 sidebar d-flex flex-column">
                <ul class="nav flex-column mb-auto">
                    ...
                    <li class="nav-item mb-1">
                        <a href="reports.php" class="nav-link py-2 px-3">
                            <i class="fa-solid fa-chart-pie me-2"></i> Reports
                        </a>
                    </li>
                    <li class="nav-item mb-1">
                        <a href="records.php" class="nav-link active py-2 px-3">
            ...
            <div class="col-md-10 p-4 main-panel">
                <div class="content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="h3 fw-bold mb-0 text-dark">Master Records Directory</h2>
                    </div>

                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-white py-3">
                            <h6 class="m-0 fw-bold text-dark"><i class="fa-solid fa-database me-2 text-success"></i>All System Submissions</h6>
                        </div>
